...
<blockquote>
  <strong>Author:</strong> Security Research and Engineering Team<br>
  <strong>Audience:</strong> Cybersecurity Analysts, Detection Engineers, Site Reliability Engineers (SREs)
</blockquote>
...
<table>
  <thead>
    <tr><th>Platform</th><th>Focus Areas</th><th>Native Security Tools</th></tr>
  </thead>
  <tbody>
    <tr>
      <td><strong>AWS</strong></td>
      <td>Serverless (Lambda), IAM, S3, CloudTrail, VPC, GuardDuty</td>
      <td>CloudTrail, GuardDuty, Security Hub, Detective, AWS Config</td>
    </tr>
    <tr>
      <td><strong>Azure</strong></td>
      <td>AD Identity, Log Analytics, Function Apps, Key Vault, Containers</td>
      <td>Microsoft Defender XDR, Azure Sentinel, Azure Monitor</td>
    </tr>
    <tr>
      <td><strong>GCP</strong></td>
      <td>IAM, SCC, VPC, Cloud Functions, Pub/Sub, BigQuery</td>
      <td>Security Command Center, Cloud Audit Logs, Google SecOps</td>
    </tr>
  </tbody>
</table>
