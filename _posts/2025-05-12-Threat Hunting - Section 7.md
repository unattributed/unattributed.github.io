...
<table>
  <thead>
    <tr><th>Platform</th><th>Data Sources</th><th>Elastic Integration</th></tr>
  </thead>
  <tbody>
    <tr>
      <td>AWS</td>
      <td>CloudTrail, VPC Flow Logs, GuardDuty</td>
      <td>Filebeat modules, AWS input via S3 + CloudWatch</td>
    </tr>
    <tr>
      <td>Azure</td>
      <td>Log Analytics, Azure AD Logs, Defender</td>
      <td>Event Hub -> Logstash/Beats pipeline</td>
    </tr>
    <tr>
      <td>GCP</td>
      <td>Audit Logs, SCC, VPC Flow Logs</td>
      <td>Pub/Sub + Elastic Agent or Google Log Export to GCS</td>
    </tr>
  </tbody>
</table>
