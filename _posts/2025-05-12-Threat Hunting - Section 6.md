...
<table>
  <thead>
    <tr><th>Time</th><th>Detected Threat</th><th>Severity</th><th>Recommended Action</th></tr>
  </thead>
  <tbody>
    <tr>
      <td>08:00 UTC</td>
      <td>Unauthorized access attempt from IP 192.0.2.1</td>
      <td>High</td>
      <td>Block IP and investigate user credentials</td>
    </tr>
    <tr>
      <td>09:30 UTC</td>
      <td>Malware detected in uploaded file</td>
      <td>Medium</td>
      <td>Quarantine file and notify user</td>
    </tr>
  </tbody>
</table>
